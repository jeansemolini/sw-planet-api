...
@Sql(scripts = {"/import_planet.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
...
public class PlanetIT {
    ...
    @Test
    public void getPlanet_ReturnsPlnet() {
    ...
    public void listPlanets_ByClimate_ReturnsAllPlanets() {
        ResponseEntity<Planet[]> sut = restTemplate.getForEntity("/planets?climate=arid",
                Planet[].class);
